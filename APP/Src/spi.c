...
SPI_HandleTypeDef SPI2_Handler;  //SPI3句柄
...
void SPI2_Init(void)
{
    ...
    HAL_SPI_Init(&SPI2_Handler);//初始化SPI3
    
    __HAL_SPI_ENABLE(&SPI2_Handler);                    //使能SPI3
}
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
    ...
    __HAL_RCC_SPI2_CLK_ENABLE();        //使能SPI3时钟
    ...
    GPIO_Initure.Alternate=GPIO_AF5_SPI2;           //PB3.5复用为SPI3
